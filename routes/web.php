...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['prefix' => 'report', 'as' => 'report/'], function(){
        ...
        Route::prefix('openbill')->group(function () {
            ...
            Route::get('/openbill/data', [OpenBillController::class, 'getOpenBillDataTable'])->name('openbill/data');
    ...
    Route::group(['prefix' => 'warehouse', 'as' => 'warehouse/'], function(){
        Route::prefix('inventory')->group(function () {
            ...
            Route::get('/detail/{inventory}', [InventoryController::class, 'detail'])->name('inventory/detail');
            ...
            Route::get('/{inventory}/stock-balances/create', [InventoryController::class, 'createStockBalance'])->name('inventory/stock-balances/create');
            Route::post('/{inventory}/stock-balances/store', [InventoryController::class, 'storeStockBalance'])->name('inventory/stock-balances/store');
            Route::get('/{inventory}/stock-balances/{stockBalance}/edit', [InventoryController::class, 'editStockBalance'])->name('inventory/stock-balances/edit');
            Route::put('/{inventory}/stock-balances/{stockBalance}/update', [InventoryController::class, 'updateStockBalance'])->name('inventory/stock-balances/update');
            Route::delete('/{inventory}/stock-balances/{stockBalance}/destroy', [InventoryController::class, 'destroyStockBalance'])->name('inventory/stock-balances/destroy');
        });
