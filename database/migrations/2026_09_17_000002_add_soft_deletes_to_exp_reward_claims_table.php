...
return new class extends Migration
{
     ...
     * exp_reward_claims ke mobile (Room/SQLite).
     *
    ...
    {
        Schema::table('exp_reward_claims', function (Blueprint $table) {
            $table->softDeletes();
            $table->index(['updated_at', 'id'], 'exp_reward_claims_updated_at_id_index');
        });
    }
    ...
    {
        Schema::table('exp_reward_claims', function (Blueprint $table) {
            $table->dropIndex('exp_reward_claims_updated_at_id_index');
