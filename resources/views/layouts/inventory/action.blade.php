<div class="btn-group" role="group">
    ...
    <ul class="dropdown-menu">
        @can('read warehouse/inventory')
            <li>
                <a class="dropdown-item" href="{{ route('warehouse/inventory/detail', $inventory->id) }}">
        ...
        @can('update warehouse/inventory')
            <li>
                <a class="dropdown-item action" href="{{ route('warehouse/inventory/edit', $inventory->id) }}">
        ...
        @can('delete warehouse/inventory')
            <li>
                <a class="dropdown-item delete text-danger" href="{{ route('warehouse/inventory/destroy', $inventory->id) }}">
