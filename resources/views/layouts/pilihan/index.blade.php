    ...
    <div class="main-content">
        ...
        <div class="card mt-4">
            <div class="card-header d-flex justify-content-end">
                ...
                @can('create library/pilihan')
                    <a href="{{ route('library/pilihan/create') }}" type="button"
                        class="btn btn-primary btn-round ms-auto action"><i class="fa fa-plus"></i>Tambah Pilihan</a>
                @endcan
            </div>
            <div class="card-body">
