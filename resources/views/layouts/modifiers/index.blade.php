...
@section('content')
    <div class="main-content">
        ...
        <div class="card mt-4">
            <div class="card-header d-flex justify-content-end">
                ...
                @can('create library/modifiers')
                    <a href="{{ route('library/modifiers/create') }}" type="button"
                        class="btn btn-primary btn-round ms-auto action"><i class="fa fa-plus"></i>Tambah Modifiers</a>
                @endcan
            </div>
            <div class="card-body">
    ...
    @push('js')
        ...
        <script>
            ...
            const datatable = 'modifiersdatatables-table';
