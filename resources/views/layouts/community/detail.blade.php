...
@section('content')
    <div class="main-content">
        <div class="card text-center">
            <h5 class="card-header">Detail {{ $data->community }}</h5>
        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-7 col-stats">
                                        <div class="numbers">
                                            <p class="card-category">Total Exp Community</p>
                        ...
                        <div class="card card-stats card-round">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-7 col-stats">
                                        <div class="numbers">
                                            <p class="card-category">Jumlah Transaksi Community</p>
                                            <h4 class="card-title" id="count-transaction">{{ $sumTransaction }}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-stats card-round">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-7 col-stats">
                                        <div class="numbers">
                                            <p class="card-category">Jumlah Nominal Transaksi Community</p>
                                            <h4 class="card-title" id="transaction-nominal">{{ $transactionNominal }}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
