...
<body>
    ...
    <div class="container" id="DivIdToPrint">
        <div class="receipt_header">
            <center>
                <img src="{{ asset('img/Logo Red.png') }}" alt="" class="circle-image" style="margin-top: 10px;">
            </center>
        ...
        <div class="receipt_body">
            ...
            <div class="card" style="padding:10px; margin-top: 20px; margin-bottom: 50px;">
                ...
                <center>
                    ...
                    <a href="https://www.instagram.com/ud.djaya" target="_blank" style="text-decoration:none; ">
                        <img src="https://cdn-icons-png.flaticon.com/512/174/174855.png" alt="Instagram" width="24" height="24" style="display:inline-block; border:0; margin-top: 20px;" />
                      </a>
            ...
            <center>
                <small
                 style="color: rgb(121, 117, 117); ">Copyright ©2025 Djaya Abadi Sejahtera<sup>®</sup>. All rights reserved. </small>
            </center>
        </div>
