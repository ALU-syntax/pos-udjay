                ...
                <table width="750" cellpadding="20" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td colspan="2" style="font-size:28px; line-height:1.4; padding-bottom:20px;">
                            ...
                            <i>EXP [exp saat ini], kamu berhak mendapatkan</i> <br>
                            <i>reward level saat ini</i>
                            <br>
                            <br>
                    ...
                    <tr>
                        <td colspan="2" style="font-size: 18px">
                            ...
                            <i>naik level ke [level selanjutnya]</i>
                        </td>
                    </tr>
                        ...
                        <td colspan="2" style="padding-top:10px; ">
                            <table cellpadding="0" cellspacing="0" border="0" width="100%"
                                ...
                                <tr>
                                    ...
                                    <td style="border:1px solid #b83b3a; padding:10px; background-color: #f4eee3;" >
