                ...
                <table width="750" cellpadding="20" cellspacing="0" border="0"
                    ...
                    <tr style="padding: 0px 10px;">
                        <td style="font-size:24px; line-height:1.4; padding-bottom:0px;">
                            ...
                            <i>Kamu telah <b>menukarkan</b> poin sebanyak</i>
                        </td>
                    </tr>

                    <!-- Tabel utama -->
                    <tr style="padding: 0px 10px;">
                        <td colspan="2" style="font-size:64px; line-height:0; padding-top:0; padding-bottom:0; color:#b83b3a; font-family: 'BNBoop';">
                            <h1>- {{$data['pointDigunakan']}}</h1> <br>
