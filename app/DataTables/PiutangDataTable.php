...
class PiutangDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($row) {
                return view('layouts.piutang.action', [
                    'edit' => route('library/piutang/edit', $row->id),
                    'bayar' => route('library/piutang/bayar', $row->id),
                    'routeDelete' => route('library/piutang/destroy', $row->id)
                ]);
            })
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('kategori_pengeluaran_id'),
